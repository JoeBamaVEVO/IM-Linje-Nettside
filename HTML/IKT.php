...
<div class="HeadContainer">
    <h1> Mer om IKT Linjen her på Amalie Skram </h1>
</div>
...
<div class="Innhold2">
    <div class="HvaErIKT">
        ...
        <div class="fag">
            <div class="AvsnittTyp1 ">
                <h2>Konseptutvikling og Programmering</h2>
                <p>Konseptutvikling og programmering er ett av de 3 programfagene ved IKT og Medie-Linjen. I dette faget vil du lære programmeringspråk som HTML, Python, Javascript og mer. <br> Du vil også lære om design og hvordan gjøre dine ideer og konsepter om til et ferdig produkt. </p>
            </div>
            <div class="AvsnittTyp1 ">
